...
class DashboardController extends Controller
{
   ...
   *
   * El middleware 'auth' asegura que el usuario esté autenticado antes de acceder a las rutas.
   */
   ...
   *
   * Verifica si el usuario tiene permiso para ver los reportes ('view_reports').
   * Si el usuario tiene el permiso, se redirige a la vista del dashboard correspondiente.
   * Si no, se redirige al home con un mensaje de error.
   *
  ...
  /**
   * Muestra el dashboard del administrador con datos generales.
   *
   * Recopila los usuarios, tareas y áreas de la base de datos y los pasa a la vista.
   *
  ...
  /**
   * Muestra el dashboard del editor con tareas filtradas.
   *
   * Filtra las tareas de acuerdo con los parámetros proporcionados en la solicitud (como búsqueda,
   * área, mes, año y estado) y las pasa a la vista del dashboard.
   *
   * @param \Illuminate\Http\Request $request
   * @return \Illuminate\View\View
   */
  ...
  /**
   * Muestra el dashboard de reportes con estadísticas y tareas.
   *
   * Verifica si el usuario tiene el permiso 'view_reports'. Si tiene el permiso, obtiene estadísticas
   * sobre las tareas (próximas, retrasadas, completadas) y otros datos relacionados.
   * Si el usuario es administrador, también se incluyen datos sobre usuarios y roles.
   *
   * @return \Illuminate\View\View
   */
