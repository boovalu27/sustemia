...
class UserController extends Controller
{
   ...
   * y los pasa a la vista para que se muestren en una lista.
   *
   ...
   *
   * Este método obtiene un usuario y sus permisos asociados,
   * luego los pasa a la vista para mostrar los detalles del usuario.
   *
   ...
   *
   * Este método obtiene todos los roles y permisos disponibles
   * y los pasa a la vista para permitir la creación de un usuario.
   *
   * @return \Illuminate\View\View
   */
   ...
   *
   * Este método valida los datos enviados por el usuario, luego crea
   * un nuevo usuario en la base de datos y asigna el rol y los permisos correspondientes.
   *
   ...
   *
   * Este método obtiene el usuario, los roles y los permisos,
   * y los pasa a la vista para permitir la edición de los datos del usuario.
   *
   * @param \App\Models\User $user
   * @return \Illuminate\View\View
   */
   ...
   *
   * Este método valida los datos enviados por el usuario y luego
   ...
   *
   * Este método permite eliminar un usuario de la base de datos.
