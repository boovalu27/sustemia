...
Route::middleware('auth')->group(function () {
  ...
  // Dashboard de reportes (requiere permiso de ver reportes)
  ...
  // Rutas de administración para tareas (requiere el permiso de ver tareas)
  Route::prefix('tasks')->name('tasks.')->middleware('permission:view_tasks')->group(function () {
    Route::get('/', [TaskController::class, 'index'])->name('index');
  });

  // Rutas de administración de tareas (requiere el permiso de crear tareas)
...
Route::middleware(['auth'])->group(function () {
  ...
  Route::prefix('areas')->name('areas.')->group(function () {
    ...
    Route::get('/create', [AreaController::class, 'create'])->middleware('permission:create_areas')->name('create');
