...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::2aZdaCeiFSqzSFfL',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/_debugbar/c(?|lockwork/([^/]++)(*:39)|ache/([^/]++)(?:/([^/]++))?(*:73))|/tasks/(?|([^/]++)(*:99)|create(*:112)|([^/]++)(?|/(?|edit(*:139)|confirm\\-delete(*:162))|(*:171)))|/users/([^/]++)(?|/(?|edit(*:207)|toggle(*:221))|(*:230))|/areas/([^/]++)(?|(*:257)|/edit(*:270)|(*:278)))/?$}sDu',
    ),
    3 => 
    array (
      39 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:828:"function () {
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'C:\\\\xampp\\\\htdocs\\\\sustemia\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Foundation\\\\Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AuthenticationController@processLogin',
        'controller' => 'App\\Http\\Controllers\\AuthenticationController@processLogin',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DashboardController@reportsDashboard',
        'controller' => 'App\\Http\\Controllers\\DashboardController@reportsDashboard',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\TaskController@confirmDelete',
        'controller' => 'App\\Http\\Controllers\\TaskController@confirmDelete',
        'as' => 'tasks.confirmDelete',
        'namespace' => NULL,
        'prefix' => '/tasks',
        'where' => 
        array (
