        ...
        <div class="alert alert-white shadow-lg p-3 mb-5 rounded p-3 mb-5 bg-body d-flex align-items-center">
            <div class="flex-wrap w-100 justify-content-between">
                ...
                <div class="d-flex align-items-center me-2 me-md-3 mb-2">
                    <i class="bi bi-calendar-x text-danger fs-5 me-2 px-1" title="Tarea vencida"></i>
                    <span>Tarea Vencida</span>


                <!-- Tarea Pendiente -->

                    <i class="bi bi-hourglass-split text-warning fs-5 me-2 px-1" title="Tarea pendiente"></i>
                    <span>Tarea Pendiente</span>


                <!-- Tarea Completada -->
                    <i class="bi bi-check-circle text-success fs-5 me-2 px-1" title="Tarea completada"></i>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 border-0
                ...
                <div class="card-body d-flex flex-column border border-shadow rounded">
                    <div class="d-flex justify-content-end align-items-center mb-3">


                        <!-- Título -->
                        <h5 class="card-title mb-0 border-bottom border-black pb-2 text-start text-truncate">{{ $task->title }}</h5>
