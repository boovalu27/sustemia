...
@section('content')
  <div class="container mt-2">
    ...
    <!-- Verificar si no hay tareas registradas -->
    @if ($tasks->isEmpty())
    ...
    @else
      <div class="table-responsive border rounded-2 p-3">
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <!-- Iterar sobre las tareas y mostrar sus datos -->
            @foreach ($tasks as $task)
              <tr>
                ...
                <td>
                  <!-- Mostrar el estado de la tarea con color de fondo adecuado -->
                  <span class="badge
                    ...
                    @endif
                  ">
                    <!-- Icono y mensaje si la tarea está completada con retraso -->
                ...
                <td>
                  <div class="d-flex justify-content-start gap-2">
                    ...
                    @endcan
                    <!-- Botón Eliminar (abre el modal de confirmación), visible solo si el usuario tiene permisos -->
                    @can('delete_tasks')
                    ...
                    @endcan
                    <!-- Botón Ver Detalles, visible solo si el usuario tiene permisos -->
                    @can('view_tasks')
